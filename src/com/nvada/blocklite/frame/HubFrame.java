...
import com.nvada.blocklite.net.Hub;
import com.nvada.blocklite.net.NetNode;

public class HubFrame extends NodeFrame {
	...
	protected void placeNodeComponents(JPanel panel) {
        ...
        JLabel recoverLabel = new JLabel("Port Number:");
	...
	protected boolean checkNodeInfo() {
		...
		if(nodeName == null || nodeName.trim().isEmpty()) {
			nodeNameField.setText("Chain.Hub");
		}
	...
	protected NetNode generateNode() {
		...
		return new Hub(nodeName, port);
	}
	
	 public static void main(String[] args) {
	 	Logger.getInstance();
	 	HubFrame hubFrame = new HubFrame();
	 	hubFrame.setExitOnClose();
	 	hubFrame.show();
    }
}
